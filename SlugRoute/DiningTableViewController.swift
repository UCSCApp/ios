...
class DiningTableViewController: UIViewController{
    ...
    @IBAction func college8Oakes(_ sender: UIButton) {
    ...
    @IBAction func college910(_ sender: UIButton) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
    ...
    @IBAction func cowellstevenson(_ sender: UIButton) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
    ...
    @IBAction func porterkresge(_ sender: UIButton) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
    ...
    @IBAction func merrill(_ sender: UIButton) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let yourNextViewController = (segue.destination as! MealsTableViewController)
